...
// Requires env vars: GOOGLE_CLOUD_PROJECT_ID, GOOGLE_CLOUD_CLIENT_EMAIL, GOOGLE_CLOUD_PRIVATE_KEY
// Get these from a service account key JSON (console.cloud.google.com → IAM → Service Accounts)
